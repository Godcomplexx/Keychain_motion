...
| наклонили круто и держите 1.5 с | запускает игру с частицами | P3 |
...
Вызывается она жестом: **наклонить круто и подержать полторы секунды**, как
наклоняют стакан. Порог 0.8 g — случайно при обычном обращении не выйдет. Игра
идёт 30 секунд, и наклон во время неё работает как управление: он не отменяет
её и не переключает питомца на разглядывание сторон.
