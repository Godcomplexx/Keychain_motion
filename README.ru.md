...
| дольше | одно из трёх самостоятельных занятий, см. ниже | P3 |
...
Когда питомца долго не трогают, он находит себе дело. Занятий три:

| Занятие | Что на экране | Длительность |
|---|---|---:|
| `act_fluid` | **анимация частиц FLIP** — та самая, из версии 1: наклон гоняет жидкость по экрану | 12 с |
...
пауза 40–120 секунд, каждое занятие не повторяется чаще раза в 5 минут, и два
подряд одинаковых не выпадают. Любое взаимодействие обрывает занятие в тот же
тик.

**Где FLIP.** Он никуда не делся, но стоит быть точной. Это первое из трёх
занятий, и **после включения оно всегда идёт первым** — включите плату и не
трогайте её секунд двадцать. Дальше занятия чередуются, и выбрать конкретное
нельзя: жеста или команды, вызывающей частицы по требованию, сейчас нет.
